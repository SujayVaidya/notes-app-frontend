...
export function BackgroundBeams({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <radialGradient id="beam-gradient-1">
          <stop offset="0%" stopColor="#18CCFC" stopOpacity="0" />
          <stop offset="100%" stopColor="#18CCFC" stopOpacity="0.1" />
        </radialGradient>
        <radialGradient id="beam-gradient-2">
          <stop offset="0%" stopColor="#6344F5" stopOpacity="0" />
          <stop offset="100%" stopColor="#6344F5" stopOpacity="0.1" />
        </radialGradient>
        <radialGradient id="beam-gradient-3">
